...
export default function BrowseRoom() {
  ...
  const { data, status, error, run, isLoading } = useAsync({ data: {username: "Lorem Ipsum"} });

  useEffect(() => {
    run(
      fetch(
        'https://fcae43df-5262-4eb4-b7fd-6873c215b249.mock.pstmn.io/api/categories/?page=1&limit=4'
      ).then( async (response) => {
